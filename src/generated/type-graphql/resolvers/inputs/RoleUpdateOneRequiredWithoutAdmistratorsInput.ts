...
import { RoleUpsertWithoutAdmistratorsInput } from "../inputs/RoleUpsertWithoutAdmistratorsInput";
import { RoleWhereUniqueInput } from "../inputs/RoleWhereUniqueInput";

@TypeGraphQL.InputType({
  isAbstract: true
})
export class RoleUpdateOneRequiredWithoutAdmistratorsInput {
  ...
  @TypeGraphQL.Field(_type => RoleUpsertWithoutAdmistratorsInput, {
    nullable: true
  })
  upsert?: RoleUpsertWithoutAdmistratorsInput | undefined;
  ...
  update?: RoleUpdateWithoutAdmistratorsInput | undefined;
}
